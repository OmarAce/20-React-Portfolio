...
export const PortfolioText: React.FC = () => {
  return (
      ...
      <div className="bg-lightblack w-full h-full flex flex-row justify-between rounded-xl xxs:flex-col sm:flex-row">
        ...
        <div className="flex flex-col justify-between">
          ...
          <p className="text-white p-6 text-xl text-right xxs:text-center sm:text-right">
            ...
            other programmers solve problems, regardless if they work on the
            back end or front end sides of a project. I have experience in
            testing and debugging software to help keep code optimized; as well
            as reprocessing inefficient code to help reduce required processing
